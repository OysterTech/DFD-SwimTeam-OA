<div class="well col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 text-center col-xs-10 col-xs-offset-1">
  ...
  <div class="col-md-offset-2" style="line-height:12px;">
    <div class="input-group">
      <span class="input-group-addon">比赛<br><br>名称</span>
    ...
    <div class="input-group">
      <span class="input-group-addon">报名<br><br>截止日期</span>
      ...
      <select id="EndMonth" class="form-control">
        ...
        ?>
        <option value="<?php echo $m1; ?>"><?php echo $m1; ?> 月</option>
        <?php } ?>
      </select>
      <select id="EndDay" class="form-control">
        ...
        ?>
        <option value="<?php echo $d1; ?>"><?php echo $d1; ?> 日</option>
        <?php } ?>
      </select>
    </div>
    <hr>
