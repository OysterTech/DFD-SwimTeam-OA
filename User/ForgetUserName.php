...
<div class="well col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 text-center col-xs-10 col-xs-offset-1">
  ...
  <div class="input-group">
    ...
    <input class="form-control" ID="RealName" autocomplete="off" onkeyup="if(event.keyCode==13)$('#Password')[0].focus();">
    <span class="input-group-addon" ID="forgot">&lt;</span>
  </div>
  ...
  <div class="input-group">
    ...
    <input type="password" class="form-control" ID="vrf_Password" onkeyup="if(event.keyCode==13)$('#Phone')[0].focus();">
    <span class="input-group-addon" ID="forgot">&lt;</span>
  </div>
  <hr>
    <div class="input-group">
    <span class="input-group-addon">手机号</span>
    <input type="text" class="form-control" name="Phone" id="Phone" onkeyup="if(event.keyCode==13 || this.value.length==11){$('#Sex')[0].focus();}">
    <span class="input-group-addon" id="forgot">&lt;</span>
  </div>
  <div class="input-group">
  ...
  <div class="input-group">
    ...
    <select name="IDCardType" id="IDCardType" class="form-control" onchange="if(this.value!='1'){$('#YearGroup').removeAttr('disabled');}">
  ...
  <div class="input-group">
    ...
    <input type="text" class="form-control" name="YearGroup" id="YearGroup" placeholder="例:2017" onfocus="getYearGroup()" disabled>
    <span class="input-group-addon" id="forgot">&lt;</span>
  </div>
  ...
  if(IDCardType==1){
    ...
    success:function(got){
      if(got=="1"){
        ...
        showModalErr("服务器错误！<br><br>请提交错误码给管理员：<br>"+got+"<br>联系方式：<a href='../View/ContactAdmin.php'>点此查看</a>");
		      return false;
      }
    }  
  });
