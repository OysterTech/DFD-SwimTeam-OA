...
$OprURL_edit=makeOprBtn("info","Role","EditRoleData.php",[["RID",$RID],["n",$name]],"编辑");
$OprURL_del=makeOprBtn("danger","Role","toDelRole.php",[["RID",$RID]],"删除");
  if($isSuper=="1"){
    $OprURL_purv=makeOprBtn("success","Role","UpdatePurviewforSystem.php",[["RID",$RID]],"更新权限");  
  }else{
    $OprURL_purv=makeOprBtn("success","Role","SelectPurview.php",[["RID",$RID]],"分配权限");
  }
?>
